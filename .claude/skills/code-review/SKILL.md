---
name: code-review
description: Code review covering architecture adherence, testability, test coverage, and code quality. Use when asked to review the codebase or check for architectural violations.
---
