...
description: Architecture review covering spec compliance, automated checks, independent file analysis, and suggestions for improving the checks themselves.
